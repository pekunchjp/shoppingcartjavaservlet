...
<body>
	...
	<div class="header">
		<div class="container">
			...
			<div class="w3l_logo">
				<h1>
					<a href="HomeServlet">Lazy's Fashion Shop<span>For Fashion
							Lovers</span></a>
				</h1>
			</div>
			<div class="search">
			...
			<div class="cart box_1">
				<a href="CartServlet"> <img src="images/bag.png" alt="" />
				</a>
	...
	<div class="checkout">
		<div class="container">
		<c:if test="${listOrderLine.size() != 0}">
			<h3>
				Your shopping cart contains: <span>${listOrderLine.size()}
					Products</span>
			</h3>
			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tbody>
						<c:forEach var="od" items="${listOrderLine }">
							<c:forEach var="p" items="${listProducts}">
								<c:if test="${p.getProductID() == od.getProductID()}">
									<tr class="rem">
										<td class="invert"></td>
										<td class="invert-image"><a href="#"> <img
												src="${p.getImage()}" alt=" " class="img-responsive" />
										</a></td>
										<td class="invert">
											<div class="quantity">
												<div class="quantity-select">
													<!-- neu so luong mua hang lon 1 => co the tru dc -->
													<c:if test="${od.getQuantity() > 1 }">
														<a href="UpdateOrderLineServlet?orderLineID=${od.getOrderLineID()}&act=minus">
															<div class="entry value-minus active"></div>
														</a>
													</c:if>
													<!-- neu so luong mua = 1 => so luong toi thieu -->
													<c:if test="${od.getQuantity() == 1 }">
														<a href="UpdateOrderLineServlet?orderLineID=${od.getOrderLineID()}&act=minus" class="disabled">
															<div class="entry value-minus active"></div>
														</a>
													</c:if>
													<div class="value">
														<span>${od.getQuantity()}</span>
													</div>
													<c:if test="${od.getQuantity() < p.getQuantity() }">
														<a href="UpdateOrderLineServlet?orderLineID=${od.getOrderLineID()}&act=plus">
															<div class="entry value-plus active"></div>
														</a>
													</c:if>
													<c:if test="${od.getQuantity() == p.getQuantity() }">
														<a href="UpdateOrderLineServlet?orderLineID=${od.getOrderLineID()}&act=plus" class="disabled">
															<div class="entry value-plus active"></div>
														</a>
													</c:if>
												</div>
										...
										<td class="invert">${p.getName()}</td>
										<td class="invert">$${p.getPrice() * od.getQuantity()}</td>
										<td class="invert">
											<div class="rem">
												<a
													href="DeleteOrderLineServlet?orderLineID=${od.getOrderLineID()}">
													<div class="close"></div>
												</a>
											</div>
										</td>
				...
				<div class="checkout-left-basket">
					...
					<ul>
						<c:forEach var="od" items="${listOrderLine}">
							<c:forEach var="p" items="${listProducts}">
								<c:if test="${p.getProductID() == od.getProductID()}">
									<li>${p.getName()} <i>-</i> <span>$${p.getPrice() * od.getQuantity()}</span></li>
								</c:if>
							</c:forEach>
						</c:forEach>
						<li>Total <i>-</i> <span>$${order.getTotalAmount()}</span></li>
					</ul>
					<div class="pay">
						<a href="CompleteOrderServlet?orderID=${order.getOrderID()}"><span aria-hidden="true"></span>PAY</a>
					</div>
				</div>
				<div class="checkout-right-basket">
					<a href="HomeServlet"><span
		...
		<c:if test="${listOrderLine.size() == 0}">
			<div class="empty-cart">
				<p class="message">KHONG CO SAN PHAM NAO TRONG GIO HANG CUA BAN.</p>
				<a href="HomeServlet" class="btn btn-yellow">TIEP TUC MUA SAM</a>
			</div>
		</c:if>
		</div>
	</div>
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							...
							<h5>
								<a href="single.html">Pink Flared Skirt</a>
							</h5>
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							...
							<h5>
								<a href="single.html">Red Pencil Skirt</a>
							</h5>
							<div class="simpleCart_shelfItem">
								<p class="flexisel_ecommerce_cart">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							...
							<h5>
								<a href="single.html">Yellow Cotton Skirt</a>
							</h5>
							<div class="simpleCart_shelfItem">
								<p class="flexisel_ecommerce_cart">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left dresses_grid">
							...
							<h5>
								<a href="single.html">Black Short</a>
							</h5>
							<div class="simpleCart_shelfItem">
								<p class="flexisel_ecommerce_cart">
