...
<title>Lazy Shop - San pham moi nhat</title>
								...
								<div class="row">
									...
									<div class="col-sm-3">
										<ul class="multi-column-dropdown">
											...
											<li><a href="NewProductServlet"><i>Summer Store</i></a></li>
										</ul>
									</div>
									<div class="col-sm-2">
										<ul class="multi-column-dropdown">
			...
			<div class="w3ls_dresses_grids">
				...
				<div class="col-md-8 w3ls_dresses_grid_right">
					...
					<div class="w3ls_dresses_grid_right_grid2">
						<a class="btn btn-default" href="CategoryServlet?limit=${limit-6}&categoryID=${categoryID}">Previous</a>
						<a class="btn btn-default" href="CategoryServlet?limit=${limit+6}&categoryID=${categoryID}">Next</a>
					</div>
