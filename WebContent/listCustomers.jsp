            ...
            <div class="row content">
                <div class="col-sm-3 sidenav">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li><a href="ListCustomersServlet">Người dùng</a></li>
                ...
                <div class="col-sm-9">
					<div>
						<h2 class="heading">Danh sách người dùng</h2>
					</div>
					<table class="table table-striped">
						...
						<tbody>
							<c:forEach var="p" items="${listCustomers}">
								<tr>
								<th scope="row">${p.getCustomerID()}</th>
								<td>${p.getName()}</td>
								<td>
									<a href="UpdateCustomerServlet?customerID=${p.getCustomerID()}">
										<span class="glyphicon glyphicon-edit"></span>
									</a> 
									<a href="DeleteCustomerServlet?productID=${p.getCustomerID()}" style="margin-left: 30px;">
